...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'responses_response', 'url', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'Response.url'
        db.alter_column(u'responses_response', 'url', self.gf('django.db.models.fields.CharField')(max_length=50))
